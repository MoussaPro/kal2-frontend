<template>
    <div class="flex flex-col bg-gray-700 items-center justify-center h-screen w-full">
      ...
      <div class="w-[1000px] flex bg-white">
          <div class="w-1/2 bg-green-100 p-12">
            <img src="@/assets/images/logo_black.png" class="w-16"/>
          ...
          <div class="w-1/2 p-12">
            ...
            <form method="post" @submit.prevent="submit" class="mt-10">
              ...
              <p class="text-gray-400 text-sm font-light font-inter mt-10 underline hover-transition hover:text-gray-800 pb-10 cursor-pointer">Glemt din adgangskode?</p>
            </form>
          </div>
      </div>
    </div>
