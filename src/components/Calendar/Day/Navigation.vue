<template>
  <div class="relative">
    <h2 class="font-medium text-gray-600 hover-transition hover:text-white hover:bg-primary rounded-md cursor-pointer py-1 px-2 capitalize" @click="dayNumberNavigation = !dayNumberNavigation">{{ title }}</h2>
